...
expName = 'Salience_RO'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/mettapham/Downloads/HOMES_RankOrder-Salience/Salience_RO_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text='Welcome to the Salience Rank Ordering Task ',
    font='Open Sans',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='In this task, you will rank the following items from 1 - 14 according to salience. 1 being least salient and 14 being the most salient. Salience is defined as being distinct, prominent, or remarkable. \n\nPress SPACE to begin',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
image1 = visual.ImageStim(
    win=win,
    name='image1', 
    image='images_RO_Sal/Landmark1.png', mask=None, anchor='center',
...
image2 = visual.ImageStim(
    win=win,
    name='image2', 
    image='images_RO_Sal/Landmark2.png', mask=None, anchor='center',
...
image3 = visual.ImageStim(
    win=win,
    name='image3', 
    image='images_RO_Sal/Landmark3.png', mask=None, anchor='center',
...
image4 = visual.ImageStim(
    win=win,
    name='image4', 
    image='images_RO_Sal/Landmark4.png', mask=None, anchor='center',
    ori=0.0, pos=(.25,.3), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image5 = visual.ImageStim(
    win=win,
    name='image5', 
    image='images_RO_Sal/Landmark5.png', mask=None, anchor='center',
...
image6 = visual.ImageStim(
    win=win,
    name='image6', 
    image='images_RO_Sal/Landmark6.png', mask=None, anchor='center',
...
image7 = visual.ImageStim(
    win=win,
    name='image7', 
    image='images_RO_Sal/Landmark7.png', mask=None, anchor='center',
...
image8 = visual.ImageStim(
    win=win,
    name='image8', 
    image='images_RO_Sal/Landmark8.png', mask=None, anchor='center',
...
image9 = visual.ImageStim(
    win=win,
    name='image9', 
    image='images_RO_Sal/Landmark9.png', mask=None, anchor='center',
    ori=0.0, pos=(.25,0), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image10 = visual.ImageStim(
    win=win,
    name='image10', 
    image='images_RO_Sal/Landmark10.png', mask=None, anchor='center',
    ori=0.0, pos=(.5,0), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image11 = visual.ImageStim(
    win=win,
    name='image11', 
    image='images_RO_Sal/Landmark11.png', mask=None, anchor='center',
    ori=0.0, pos=(-.5,-.3), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image12 = visual.ImageStim(
    win=win,
    name='image12', 
    image='images_RO_Sal/Landmark12.png', mask=None, anchor='center',
    ori=0.0, pos=(-.25,-.3), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image13 = visual.ImageStim(
    win=win,
    name='image13', 
    image='images_RO_Sal/Landmark13.png', mask=None, anchor='center',
    ori=0.0, pos=(0,-.3), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image14 = visual.ImageStim(
    win=win,
    name='image14', 
    image='images_RO_Sal/Landmark14.png', mask=None, anchor='center',
    ori=0.0, pos=(.25,-.3), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image15 = visual.ImageStim(
    win=win,
    name='image15', 
    image='images_RO_Sal/Landmark15.png', mask=None, anchor='center',
    ori=0.0, pos=(.5,-.3), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
text_3 = visual.TextStim(win=win, name='text_3',
    text='Thank you for participating in the Salience Rank Ordering Task!',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
